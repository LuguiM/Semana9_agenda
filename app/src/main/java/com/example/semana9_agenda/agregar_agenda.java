        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            if (accion.equals("modificar")) {
                ...
                try {
                    ...
                    TextView temp = (TextView) findViewById(R.id.idCodigo);
                    temp.setText(datosJSON.getString("codigo"));

                    temp = (TextView) findViewById(R.id.idNombre);
                    temp.setText(datosJSON.getString("nombre"));

                    temp = (TextView) findViewById(R.id.idDireccion);
                    temp.setText(datosJSON.getString("direccion"));

                    temp = (TextView) findViewById(R.id.idTelefono);
                    temp.setText(datosJSON.getString("telefono"));

                    temp = (TextView) findViewById(R.id.idDUI);
                    ...
                    Toast.makeText(Agregar_agenda.this, "Error al recuperar datos" +
            ...
            btn.setOnClickListener((v) -> {
                ...
                TextView temp = (findViewById(R.id.idCodigo));
                String codigo = temp.getText().toString();

                temp = (findViewById(R.id.idNombre));
                String nombre = temp.getText().toString();

                temp = (findViewById(R.id.idDireccion));
                String direccion = temp.getText().toString();

                temp = (findViewById(R.id.idTelefono));
                String telefono = temp.getText().toString();

                temp = (findViewById(R.id.idDUI));
                ...
                try {
                    ...
                    Toast.makeText(Agregar_agenda.this, "Error al guardar" +
                            ex.getMessage().toString(), Toast.LENGTH_LONG).show();
                }
            });
            ...
            findViewById(R.id.btRegresar);
            Button btnRegresar = (Button) findViewById(R.id.btRegresar);
                ...
                try {
                    ...
                    if (jsonObject.getBoolean("ok")) {
                        Toast.makeText(Agregar_agenda.this, "Contacto almacenado con éxito.", Toast.LENGTH_LONG).show();
                                Intent regresar = new Intent(Agregar_agenda.this,
                                        MainActivity.class);
                        startActivity(regresar);
                    } else {
                    ...
                    Toast.makeText(Agregar_agenda.this, "Error en la red." +
                            ex.getMessage().toString(), Toast.LENGTH_LONG).show();
                }
            }
